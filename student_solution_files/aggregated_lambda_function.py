...
def lambda_handler(event, context):
    ...
    list_of_extracted_phrases = [phrase['Text'] for phrase in key_phrases['KeyPhrases']]
    ...
    db_response = table.put_item(Item={'ResponseID': int(rid),
                        'Name': dec_dict['name'],
    ...
    email_text = email_response(dec_dict['name'], ['CV', 'projects', 'articles'], list_of_extracted_phrases, sentiment_response)
